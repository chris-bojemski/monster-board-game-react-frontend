...
class GameInstance extends React.Component {
  ...
  renderHoverCard = monsterId => {
    ...
    let hoveredState = `Name: ${this.capitalizeName(monster.name)}, Level: ${
      monster.evo_level
    }, HP: ${monster.hp}, Power: ${monster.power}`;
        ...
        <div className="playArea">
          <PlayerDiceContainer
            ...
            currentTurn={{
              ...
              move: this.state.p1Move,
              attack: this.state.p1Attack
            }}
            playerId={1}
          />
          ...
          <PlayerDiceContainer
            diceValueMultiplexer={this.diceValueMultiplexer}
            currentTurn={{
              turn: this.state.p2Turn,
              move: this.state.p2Move,
              attack: this.state.p2Attack
            }}
            playerId={2}
          />
        </div>
...
export default connect(mapStateToProps)(GameInstance);
